<template>
  <div v-if="species" class="flex flex-col items-center rounded-[20px] justify-center w-[400px] sm:w-[90%] ml-[auto] mr-[auto] mt-[220px] min-h-[370px] bg-white text-black p-4">
    <img
    ...
    />
    <h1 class="text-3xl font-bold mb-4 font-jediFont tracking-[2px] text-[black] [text-shadow:0px_0_3px_#fcdf2b] text-center">{{ species.name }}</h1>
